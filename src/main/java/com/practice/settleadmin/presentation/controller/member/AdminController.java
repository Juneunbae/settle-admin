...
public class AdminController {
	...
	public ResponseEntity<AdminCreateStoreOwnerResDto> createStoreOwners(@RequestBody AdminCreateStoreOwnerReqDto request) {
		AdminCreateStoreOwnerReqServiceDto serviceDto = mapper.toAdminCreateStoreOwnerReqServiceDto(request);
